...
public:
    ...
    */
    ...
    @remarks
    This method normalizes the vector such that the xyz components
    form a unit vector. The w component is scaled by the same factor.
    This is useful for plane equations where (x,y,z) is the normal
    and w is the distance.
    @note
