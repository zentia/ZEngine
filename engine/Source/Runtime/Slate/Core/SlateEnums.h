...
// ZSlate: a retained-mode (UE Slate-inspired) UI framework for the ZEngine editor.
// The widget tree is the architecture; the GPU backend reuses ZEngine's existing
// ZUGUI BatchedUIRenderer (UIRenderer), so no from-scratch 2D renderer is needed.
namespace ZSlate
{
