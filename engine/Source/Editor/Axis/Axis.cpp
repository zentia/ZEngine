...
EditorTranslationAxis::EditorTranslationAxis()
{
    ...
    m_MeshData.m_StaticMeshData.m_VertexBuffer = std::make_shared<BufferData>(vertex_data_size);
    uint8_t* vertex_data = static_cast<uint8_t*>(m_MeshData.m_StaticMeshData.m_VertexBuffer->m_Data);
    ...
    m_MeshData.m_StaticMeshData.m_IndexBuffer = std::make_shared<BufferData>(index_data_size);
    uint16_t* index_data = static_cast<uint16_t*>(m_MeshData.m_StaticMeshData.m_IndexBuffer->m_Data);
