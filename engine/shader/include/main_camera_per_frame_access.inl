// Include immediately after declaring `MainCameraPerFrame per_frame` in binding 0 SSBO/cbuffer.
// Keeps mesh_lighting.inl / megalights_*.inl on legacy bare field names.
